...
const app = express();
const PORT = process.env.PORT || 4000; // Змініть 3000 на 4000
...
app.get('/geolocate', async (req, res) => {
    ...
    try {
        ...
        const response = await fetch(`https://ipinfo.io/${ip}/geo?token=8176575105c696`); // Не забудьте замінити YOUR_API_KEY
